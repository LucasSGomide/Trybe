// Inserindo a coleção movies à base de dados Class
...
db.movies.update({ title: "Batman" }, { $inc: { imdbRating: 0.1 }}); // O valor fica 7.69999 pq?
...
db.movies.updateOne({ title: "Batman" }, { $mul: { imdbRating: NumberInt("4") } });
